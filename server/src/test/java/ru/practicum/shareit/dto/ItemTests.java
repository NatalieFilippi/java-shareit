...
public class ItemTests {
    ...
    void test() throws IOException {
        ...
        assertThat(result).extractingJsonPathNumberValue("$.owner").isEqualTo((int) itemDto.getId());
        assertThat(result).extractingJsonPathBooleanValue("$.available").isEqualTo(itemDto.getAvailable());
        assertThat(result).extractingJsonPathNumberValue("$.requestId").isEqualTo((int) itemDto.getRequest());
    }
}
