...
public class BookingTests {
    ...
    void findAllById() throws Exception {
        when(bookingService.findAllById(Mockito.anyLong(), any(BookingState.class), Mockito.anyInt(), Mockito.anyInt()))
    ...
    void findAllByOwner() throws Exception {
        when(bookingService.findAllByOwner(Mockito.anyLong(), any(BookingState.class), Mockito.anyInt(), Mockito.anyInt()))
                .thenReturn(List.of(bookingRequestDto));
