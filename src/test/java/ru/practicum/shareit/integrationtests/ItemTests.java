...
public class ItemTests {
    ...
    void updateItem() {
        UserDto getUser = userService.create(userDto);
        itemDto.setOwner(userDto.getId());
        ItemDto getItem = service.create(getUser.getId(), itemDto);
        itemDto.setDescription("новое описание");
        service.update(getUser.getId(), getItem.getId(), itemDto);
    ...
    void findAllById() {
        ...
        service.create(getUser.getId(), itemDto);
        List<ItemDto> items = service.findAllById(getUser.getId(), 1, 10);
    ...
    void search() {
        ...
        itemDto.setOwner(userDto.getId());
        service.create(getUser.getId(), itemDto);
        List<ItemDto> items = service.search("ве", 1, 10);
