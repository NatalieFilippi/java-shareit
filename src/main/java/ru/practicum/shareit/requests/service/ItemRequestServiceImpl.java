...
public class ItemRequestServiceImpl implements ItemRequestService {
    ...
    @Autowired
    public ItemRequestServiceImpl(UserRepository userRepository, ItemRepository itemRepository, ItemRequestRepository requestRepository) {
    ...
    public ItemRequestDto getById(long userId, long requestId) {
        validateOwner(userId);
        ItemRequest request = requestRepository.findById(requestId).orElseThrow(() -> new ObjectNotFoundException("Запрос не найден."));
